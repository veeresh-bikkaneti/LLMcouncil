...
Analyze visual aspects, UI/UX issues, and error codes. Keep response under ${CONFIG.MAX_AGENT_RESPONSE_WORDS} words.
...
Keep response under ${CONFIG.MAX_AGENT_RESPONSE_WORDS} words. Provide actionable technical guidance.`,
...
Keep response under ${CONFIG.MAX_AGENT_RESPONSE_WORDS} words. Assess the user's needs and frustration level.`,
...
Keep response under ${CONFIG.MAX_CHAIRPERSON_RESPONSE_WORDS} words.`
} as const;
