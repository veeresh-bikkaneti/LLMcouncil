...
exports.PRIVACY_POLICY = exports.MESSAGES = exports.AGENT_PROMPTS = exports.CONFIG = void 0;
exports.CONFIG = {
    MAX_HISTORY: 50,
...
exports.AGENT_PROMPTS = {
    vision: (text) => `As a Vision Agent, analyze this text for UI/UX issues, visual aspects, and design concerns:\n\n${text}\n\nProvide specific, actionable insights about visual and user experience elements.`,
    technical: (text) => `As a Technical Librarian, provide technical solutions, documentation references, and code fixes for:\n\n${text}\n\nInclude links to relevant documentation and suggest specific implementations.`,
    empathy: (text) => `As an Empathy Analyst, assess the user sentiment, urgency level, and emotional context of:\n\n${text}\n\nIdentify frustration levels, urgency indicators, and user needs.`,
    chairperson: (analyses) => `As Chairperson, synthesize these agent analyses into a final verdict:\n\n${analyses.map((a, i) => `Agent ${i + 1}:\n${a}`).join('\n\n')}\n\nProvide a consensus recommendation with clear action items.`
};
exports.MESSAGES = {
